...
router.post("/add", (req, res) => {
  ...
  postConductor(conductor)
   .then((result) => {
     fetchConductorsAndRenderIndex(res,'','',"successfully conductor added")
   })
   .catch((err) => {
...
router.put("/:idconductor", (req,res) => {
  ...
  updateConductor(conductor)
   .then((result) => {
     fetchConductorsAndRenderIndex(res,'','',"successfully Conductor Updated!")
   })
   .catch((err) => {
    fetchConductorsAndRenderIndex(res,'',err)
   })
...
router.delete("/:idconductor", (req, res) => {
  deleteConductor(req.params.idconductor)
   .then((result) => {
      fetchConductorsAndRenderIndex(res,'','',"successfully Conductor deleted from record")
   })
   .catch((err) => {
      fetchConductorsAndRenderIndex(res,'',err)
   })
...
function renderIndexPage(res, conductors, searchOptions, errorMessage = '',greeting = ''){
...
function renderConductorPage(res,conductor,driver,errorMessage = '',greeting = ''){
...
function fetchConductorsAndRenderIndex(res,searchOptions,errorMessage = '',greeting = ''){
