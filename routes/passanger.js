...
////////////..............Passanger routes......................//////////////////
  ...
  router.post("/add", (req, res) => {
    postPassanger(req.body.name)
      .then((result) => {
        fetchPassangersAndRenderIndex(res,'','',"successfully Passanger added")
      })
      .catch((err) => {
        res.render('passangers/add')
      }) 
  ...
  router.put("/:idpassanger", (req,res) => {
    ...
    .then((result) => {
      fetchPassangersAndRenderIndex(res,'','',"successfully Passanger Updated!")
    })
    .catch((err) => {
      fetchPassangersAndRenderIndex(res,'',err)
    })
  ...
  router.delete("/:idpassanger", (req, res) => {
    ...
    .then((result) => {
        fetchPassangersAndRenderIndex(res,'','',"successfully passanger deleted from record")
    })
    .catch((err) => {
        fetchPassangersAndRenderIndex(res,'',err)
    })
...
function renderIndexPage(res, passangers, searchOptions, errorMessage = '',greeting = ''){
...
function fetchPassangersAndRenderIndex(res,searchOptions,errorMessage = '',greeting = ''){
